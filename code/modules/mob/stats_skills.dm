...
/mob
	...
	var/skills = list("melee" = 40, "ranged" = 40, "medical" = 40, "surgery" = 40, "engineering" = 40, "crafting" = 40, "cooking" = 40, "science" = 40, "cleaning" = 40, "gardening" = 40)
...
/mob/proc/statcheck(var/stat, var/requirement, var/message = null, var/type = null)//Requirement needs to be 1 through 20
	...
	log_debug("Roll: [roll], Mood affect: (-)[mood_affect(1)], Ability modifier [stat_to_modifier(stat)]") //Debuging
	log_debug("Rolled a [roll] against a DC [requirement] [type] check")  //debug
